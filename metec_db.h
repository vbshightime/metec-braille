...
uint8_t brailleKey[KEY_LENGTH];

uint8_t previousVal = 0;
uint8_t nowVal = 0;

HashType<char*, uint16_t> hashRawArray[HASH_SIZE];
HashType<int, char*> hashRawArrayBraille[HASH_SIZE];
HashMap<char*, uint16_t> hashMap = HashMap<char*, uint16_t>( hashRawArray , HASH_SIZE );
HashMap<int, char*> hashMapBrail = HashMap<int, char*>( hashRawArrayBraille, HASH_SIZE);
void hashMapChar() {
  hashMap[0]("a", 0x2801);
  hashMap[1]("b", 0x2803);
  hashMap[2]("c", 0x2809);
...
void hashMapBraille() {
  ...
  hashMapBrail[8](20, "i");
  hashMapBrail[9](22, "j");
  hashMapBrail[10](40, "k");
  hashMapBrail[11](56, "l");
  hashMapBrail[12](44, "m");
  hashMapBrail[13](46, "n");
  hashMapBrail[14](42, "o");
  hashMapBrail[15](60, "p");
  hashMapBrail[16](62, "q");
  hashMapBrail[17](58, "r");
  hashMapBrail[18](28, "s");
  hashMapBrail[19](30, "t");
  hashMapBrail[20](42, "u");
  hashMapBrail[21](58, "v");
  hashMapBrail[22](23, "w");
  hashMapBrail[23](45, "x");
  hashMapBrail[24](47, "y");
  hashMapBrail[25](43, "z");
  
  /*hashMapBrail[0](0b00100000, "a");
  hashMapBrail[1](0b00110000, "b");
  hashMapBrail[2](0b00100100, "c");
  hashMapBrail[3](0b00100110, "d");
  hashMapBrail[4](0b00100010, "e");
  hashMapBrail[5](0b00110100, "f");
  hashMapBrail[6](0b00110110, "g");
  hashMapBrail[7](0b00110010, "h");
  hashMapBrail[8](0b00010100, "i");
  hashMapBrail[9](0b00010110, "j");
  hashMapBrail[10](0b00101000, "k");
  hashMapBrail[11](0b00111000, "l");
  hashMapBrail[12](0b00101100, "m");
  hashMapBrail[13](0b00101110, "n");
  hashMapBrail[14](0b00101010, "o");
  hashMapBrail[15](0b00111100, "p");
  hashMapBrail[16](0b00111110, "q");
  hashMapBrail[17](0b00111010, "r");
  hashMapBrail[18](0b00011100, "s");
  hashMapBrail[19](0b00011110, "t");
  hashMapBrail[20](0b00101010, "u");
  hashMapBrail[21](0b00111010, "v");
  hashMapBrail[22](0b00010111, "w");
  hashMapBrail[23](0b00101101, "x");
  hashMapBrail[24](0b00101111, "y");
  hashMapBrail[25](0b00101011, "z");*/
}
...
uint8_t keyOR(uint8_t pin_1, uint8_t pin_2, uint8_t pin_3, uint8_t pin_4, uint8_t pin_5, uint8_t pin_6) {
  return (digitalRead(pin_1)&digitalRead(pin_2)&digitalRead(pin_3)&digitalRead(pin_4)&digitalRead(pin_5)&digitalRead(pin_6));
}

void makePatternSerial(char* data) {
...
void makePatternButtonBraille(uint8_t pin_1, uint8_t pin_2, uint8_t pin_3, uint8_t pin_4, uint8_t pin_5, uint8_t pin_6) {
  Serial.print("brailleKey\t");
  brailleKey[0] = ~(digitalRead(pin_1))&0x01;Serial.println(brailleKey[0]);
  brailleKey[1] = ~(digitalRead(pin_2))&0x01;Serial.println(brailleKey[1]);
  brailleKey[2] = ~(digitalRead(pin_3))&0x01; Serial.println(brailleKey[2]);
  brailleKey[3] = ~(digitalRead(pin_4))&0x01; Serial.println(brailleKey[3]);
  brailleKey[4] = ~(digitalRead(pin_5))&0x01; Serial.println(brailleKey[4]);
  brailleKey[5] = ~(digitalRead(pin_6))&0x01;Serial.println(brailleKey[5]);
  for (int i = 0; i < KEY_LENGTH - 1; i++) {
    previousVal |= brailleKey[i];
    nowVal =  previousVal << 1;
    previousVal = nowVal;
  }
  Serial.print("nowVal\t");
  Serial.println(nowVal);
  int brailleIndex = hashMapBrail.getIndexOf(nowVal);
  Serial.print("Index\t");Serial.println(brailleIndex);
  char* brailleChar = hashMapBrail.getValueOf(nowVal);
  Serial.print("brailleChar\t");Serial.println(hashMapBrail.getValueOf(nowVal));
  for(int j = 0; j<=CELL_SIZE; j++){
      if (brailleChar[j] == NULL) {
       break;
      } 
      patternBraille[j] = hashMap.getValueOf(brailleChar); 
    }
    nowVal = 0;
    previousVal = 0;
}
